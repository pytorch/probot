...
exports.logger = new bunyan_1.default({
    ...
    stream: new bunyan_format_1.default({ outputMode: toBunyanFormat(process.env.LOG_FORMAT || 'short'), color: supports_color_1.default.stdout, levelInString: !!process.env.LOG_LEVEL_IN_STRING })
});
